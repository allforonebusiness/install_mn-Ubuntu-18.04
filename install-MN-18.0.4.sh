...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='allforonebusiness.conf'
CONFIGFOLDER='/root/.allforonebusiness'
COIN_DAEMON='allforonebusinessd'
COIN_CLI='allforonebusiness-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/allforonebusiness/allforonebusiness/releases/download/v5.0.0/allforonebusiness-5.0.0-linux-ubuntu18.0.4.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='allforonebusinessd'
COIN_EXPLORER='http://blockexplorer.allforonebusiness.org/'
COIN_PORT=11888
RPC_PORT=11887
